...
original_image = cv2.imread('/Users/arundhathi/Downloads/HOME.jpg')
watermark_image = cv2.imread("C:/Users/arundhathi/Downloads/watermarked.jpg", cv2.IMREAD_UNCHANGED)
